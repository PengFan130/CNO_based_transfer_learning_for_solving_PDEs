...
folder = "TrainedModels6/"+"CNO_"+which_example
...
if which_example == "shear_layer":
    ...
    example = WaveEquation(model_architecture_, device, batch_size, training_samples, in_dist=True)
    ...
    example = ApeNS(model_architecture_, device, batch_size, training_samples, in_dist=False)
elif which_example == 'ks':
    example = KS(model_architecture_, device, batch_size, training_samples, in_dist=False)
elif which_example == 'bruss':
    example = Bruss(model_architecture_, device, batch_size, training_samples, in_dist=False)
else:
    raise ValueError()
