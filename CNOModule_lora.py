# Implementation is borrowed from paper "Convolutional Neural Operators for robust and accurate learning of PDEs" https://github.com/camlab-ethz/ConvolutionalNeuralOperator
...
from conv2d_lora import Conv2d_nlt
